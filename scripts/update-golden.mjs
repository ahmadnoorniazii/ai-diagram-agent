...
// Apply the normalized seeds to matching test cases in place, leaving
// everything else in the dataset untouched.
...
// Write the full dataset back out (existing cases + normalized seeds +
// new cases) and report the resulting counts.
