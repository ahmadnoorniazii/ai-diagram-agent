// Deletion tool for the canvas: strips elements by id. Paired with
// queryCanvas since the model needs real ids from the live scene before it
// can safely delete anything.
