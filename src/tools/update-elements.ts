...
// Every field is nullable and optional-in-spirit: null means "don't touch
// this property," so a single-field recolor still has to pass the full
// object with everything else set to null.
...
Example: updateElements({ updates: [
  ...
  // Batched by id so one call can restyle/reposition several elements at
  // once instead of round-tripping per element.
