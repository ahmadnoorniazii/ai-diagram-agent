...
// Minimal fields needed to compute bounding boxes and resolve container
// relationships; not a full Excalidraw element type.
...
// Allowed overlap tolerance in pixels — see header note above.
const EPSILON = 4;

// Extract a numeric bounding box from an element, or null if any of the
// required fields are missing/non-numeric (e.g. an element mid-creation).
